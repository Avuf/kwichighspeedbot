...
async def start(b, m):
    ...
    if usr_cmd == "/start":
        ...
        await m.reply_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [InlineKeyboardButton("⚡ 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 ⚡", url="https://t.me/kwicbotupdates"), InlineKeyboardButton("⚡ 𝚂𝚄𝙿𝙿𝙾𝚁𝚃 ⚡", url="https://t.me/Anime_Fair")],
                    [InlineKeyboardButton("📺 24/7 𝙼𝙾𝚅𝙸𝙴𝚂 📺", url="https://t.me/MoviesNowV2"), InlineKeyboardButton("💎 Anime 𝙼𝙾𝚅𝙸𝙴𝚂 💎", url="https://t.me/Fair_Movies")],
                    [InlineKeyboardButton(" 𝙼𝙾𝚅𝙸es Channe", url="https://t.me/Cyber_Movie_S")]
                ]
            ),
...
async def help_handler(bot, message):
    ...
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("⚡ Animes ⚡", url="https://t.me/Anime_Fair"), InlineKeyboardButton("⚡ 𝚂𝚄𝙿𝙿𝙾𝚁𝚃 ⚡", url="https://t.me/Fair_Cafe")],
                [InlineKeyboardButton("📺 Anime 𝙼𝙾𝚅𝙸𝙴𝚂 📺", url="https://t.me/Fair_Movies"), InlineKeyboardButton("💎𝙾𝚃𝚃 𝙼𝙾𝚅𝙸𝙴𝚂💎", url="https://t.me/cyber_movie_S")],
                [InlineKeyboardButton("💌 𝙼𝙾𝚅𝙸𝙴 𝙱𝙾𝚃 💌", url="https://t.me/anime_fair")]
